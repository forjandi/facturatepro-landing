...
const itemsConfigs = [
    { name: "item-0", color: "text-indigo-700 bg-indigo-400/10", icon: <MonitorCog className="size-6" /> },
    { name: "item-1", color: "text-cyan-700 bg-cyan-400/10", icon: <Server className="size-6" /> },
    { name: "item-2", color: "text-green-700 bg-green-400/10", icon: <Smartphone className="size-6" /> },
    { name: "item-3", color: "text-pink-700 bg-pink-400/10", icon: <Printer className="size-6" /> },
];

const IntegrationAPI = () => {
    return (
        <div className="max-w-7xl mx-auto section-padding relative my-20">
            ...
            <div className="flex items-center justify-center h-96 relative mt-10">
                <div className="absolute w-96 h-96 bg-gradient-to-r from-cyan-200 to-pink-300 rounded-full blur-3xl -z-10 animate-pulse-soft"></div>
