...
const itemsConfigs = [
  {
    name: "item-0",
    color: "text-indigo-700 bg-indigo-400/10",
    icon: <MonitorCog className="w-[60%] h-[60%] size-6" />,
  },
  {
    name: "item-1",
    color: "text-cyan-700 bg-cyan-400/10",
    icon: <Server className="w-[60%] h-[60%] size-6" />,
  },
  {
    name: "item-2",
    color: "text-green-700 bg-green-400/10",
    icon: <Smartphone className="w-[60%] h-[60%] size-6" />,
  },
  {
    name: "item-3",
    color: "text-pink-700 bg-pink-400/10",
    icon: <Printer className="w-[60%] h-[60%] size-6" />,
  },
];
    ...
    <div className="max-w-7xl mx-auto relative mt-32">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16 md:mb-32 flex flex-col items-center">
        ...
        <p className="text-sm mt-2 text-indigo-600">
          <strong>*Esta funcionalidad esta incluída en tu sucripción*</strong>
        </p>
        <p className="text-gray-600 text-base mt-8 text-left">
          Integra tu sistema fácilmente con nuestra API de facturación y
          automatiza la{" "}
          <strong>
            emisión, consulta y gestión de comprobantes electrónicos.
          </strong>{" "}
          Nuestra API utiliza autenticación basada en tokens seguros,
          permitiendo que aplicaciones de terceros accedan a funcionalidades
          clave como la emisión de facturas y descarga de documentos.
          <br />
          <br />
          <span className="w-full font-bold text-gray-700 text-left inline-block">
            ¿Por qué elegir nuestra API?
          </span>
          <ul className="list-disc list-inside mt-2 text-gray-700 text-base text-left">
            <li>
              <a
              ...
              clara y ejemplos listos para usar.
            </li>
            <li>Permite anular comprobantes emitidos.</li>
            <li>
              Soporte para integración en múltiples lenguajes y plataformas.
            </li>
